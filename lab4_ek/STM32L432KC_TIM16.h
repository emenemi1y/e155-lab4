...
// Base addresses
#define TIM15_BASE (0x40014400ULL)
...
typedef struct
{
  ...
  __IO uint32_t SMCR;        /*!< TIM16 slave mode control register,               Address offset: 0x08 */
  ...
  __IO uint32_t CCR2;        /*!< TIM16 capture/compare register 2,                Address offset: 0x38 */
...
#define TIM16 ((TIM16_TypeDef *) TIM16)
